...
module.exports.run = async(client, message, args) => {
  const duration = moment.duration(client.uptime).format(" D [gün], H [saat], m [dakika], s [saniye]");
    ...
    .addField(`Discord.js sürümü:`, Discord.version)
      .addField(':spy: Yapımcım:', '<@531240160969490472> \n `AtaQan Usta`')
      .addField(':paperclip: Botun Başlanma Zamanı:', "Bot **03.01.2019**'de yapılmaya başlanmıştır")
    .setFooter('UstaBot', client.user.avatarURL)
    .setTimestamp()
